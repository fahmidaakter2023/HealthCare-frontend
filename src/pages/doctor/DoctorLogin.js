...
export default function DoctorLogin() {
  ...
  return (
    <AuthLayout
      title="Doctor Login"
      subtitle="Access your medical portal"
      footer={<>New here? <Link to="/doctor/register" style={{ color: '#00c9a7' }}>Register as Doctor</Link><br />Are you a patient? <Link to="/patient/login" style={{ color: '#00c9a7' }}>Patient Login</Link></>}
    >
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <div><label style={lbl}>Username</label><input style={inp} name="username" placeholder="Doctor username" value={form.username} onChange={handleChange} required /></div>
